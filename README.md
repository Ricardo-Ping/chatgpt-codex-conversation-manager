...
**ChatGPT 会话管理**：搜索筛选、双击阅读完整正文（Markdown / 代码高亮 / 图片）、多选批量整理。

![ChatGPT 会话管理与阅读面板](docs/screenshots/chatgpt-chats.png)

**Codex 任务**：自动连接桌面客户端内置 App Server，按项目文件夹分组，支持批量导出与迁移。
