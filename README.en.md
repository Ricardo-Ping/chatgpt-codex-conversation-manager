...
```bash
curl -LO "https://github.com/Ricardo-Ping/chatgpt-codex-conversation-manager/releases/download/v0.7.7/Conversation-Manager-0.7.7-mac-arm64.zip"
```
...
- `v0.7.7` supports Windows x64 and macOS (Apple Silicon), both with in-app auto-update; the Windows portable build and macOS use a download-verified in-place swap because they are not signed.
