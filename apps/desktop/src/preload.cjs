...
contextBridge.exposeInMainWorld("conversationManager", Object.freeze({
  ...
  codex: Object.freeze({
    ...
    projectCreate: (name, rootPath) => ipcRenderer.invoke("codex:project-create", { name, rootPath }),
    projectRename: (projectId, name) => ipcRenderer.invoke("codex:project-rename", { projectId, name }),
    projectDelete: (projectId) => ipcRenderer.invoke("codex:project-delete", { projectId }),
